...
public class AnimalMain {
	public static void main(String[] args) {
		/*
		 * 클래스에서 클래스를 상속받을 때 		: 클래스 extends 클래스(단일상속)
		 * 클래스에서 인터페이스를 구현(상속)할때	: 클래스 implements 인터페이스,인터페이스 (다중상속)
		 * 인터페이스에서 인터페이스를 상속받을때 	: 인터페이스 extends 인터페이스, 인터페이스 (다중상속)
		 * 
		 * 			:		추상클래스		:	인터페이스 
		 * ==============================================================
		 * 상속갯수		:		단일상속		:	다중상속
		 ...
		 * 일반메소드	:		O			:	x
		 * -----------------------------------------------------------------
		 * 필드		:	일반필드 + 상수필드	:	상수필드만 (묵시적으로 public static final=>생략가능)
		 * 
		 * 
		...
		arr[1] = new Dog("뽀비","말티즈");
		arr[2] = new Eagle("독돌이","대머리");
