...
public class AfterMain {
	public static void main(String[] args) {
		 ...
		 * 	  => 내부적으로 부모객체가 먼저 생성됨
		 * 3. 자식타입의 객체를 통해서 부모클래스에 정의도어있는 멤버에 접근 가능 (단,private은 안됨)
		...
		Desktop d = new Desktop("삼성","d-01","짱짱데스크탑",99999999,true); 
		...
		SmartPhone s = new SmartPhone("애플","s-1234","아이폰",1300000,"LG");
