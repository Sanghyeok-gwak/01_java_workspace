...
public class test {
	public static void main(String[] args) {
		...
		String str = "aaa1,bbb1,35000,35000\n"
				+"aaa2,bbb2,25000,25000\n"
				+"aaa3,bbb3,15000,15000\n"
				+"aaa4,bbb4,5000,5000\n"
				+"aaa5,bbb5,45000,45000\n"
				+"aaa6,bbb6,31000,31000\n"
				+"aaa7,bbb7,35600,35600\n"
				+"aaa8,bbb8,31200,31200\n"
				+"aaa9,bbb9,33000,33000\n";
		...
		for(int i =0; i<arr.length; i++) {
			...
			userList.add(new User(temp[0],temp[1],Integer.parseInt(temp[2]),1111));		
		}
		
		
		for (int i =0; i<userList.size(); i++) {
			System.out.println(userList.get(i).getAccount());
		}
