...
public class ExMenu {
	...
	public void selectProduct() {
		...
		if(list.isEmpty()) {
			System.out.println("더이상의 제품이 존재하지 않습니다.");
		}else {
			for(Product p : list) {
	...
	public void deleteProduct() {
		...
		System.out.println("삭제하실 제품 명 : ");
		String name = sc.nextLine();
		// 삭제하고자 하는 제품의 브랜드명 입력받기 (String brand 변수에 기록)
		System.out.println("삭제하실 브랜드 명 :");
		String brand = sc.nextLine();
	...
	public void searchProduct() {
		...
		list = ec.searchProduct(sc.nextLine());
	...
	if(result== 0) {
		...
		System.out.println(brand+" 브랜드의 "+name + " 제품의 가격은 "+result+"원입니다.");
	}
