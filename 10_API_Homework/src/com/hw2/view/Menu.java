	...
	public void stringGameMenu() {
		...
		while(true) {
			...
			if(menu == 1) {
				...
				System.out.println(ca.findCharCount(s, c));
				...
				System.out.println(c2.selectTokenCount(str));
				...
				String s = sc.nextLine();
				System.out.println(c3.toSpaceUppder(s));
	...
	public void mathGameMenu() {
		...
		while(true) {
			...
			if(menu == 1) {
				...
				System.out.println(c.sumString(x, y));
			}else if(menu == 2) {
				System.out.println("\n* 정수형으로만 입력해주세요 *\n");
				...
				System.out.println(c.minusString(x, y));
	...
	public void dateGameMenu() {
		...
		while(true) {
			...
			if(menu == 1) {
				...
				System.out.println(calc.makeCalendar(num1, num2, num3));
