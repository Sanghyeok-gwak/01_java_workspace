...
public class CollectionMain {
	/*
	 * < 컬렉션 >
	 * "자료구조"를 담당하는 "프레임워크" (자료구조의 개념이 내장되어있는 자바클래스)
	 * 
	 ...
	 *  < 배열과 컬렉션 차이점 >
	 *   배열
	 *   ㄴ크기에 대한 제약이 많음 (크기지정 필수, 한번지정된 크기 변경불가)
	 *   ㄴ중간 위치에 추가하거나 삭제할 경우 => 복잡한 로직 코드를 직접 작성해야됨
	 *   ㄴ한 타입의 데이터만 저장가능
	 *   
	 *   컬렉션
	 *   ㄴ크기에 대한 제약이 없음(크기지정 필수 x, 유동적으로 크기변경됨)
	 *   ㄴ중간 위치에 추가하거나 삭제할 경우 복잡한 로직을 짤 필요 없음 => 이미 구현되어있는 메소드
	 * 	 ㄴ여러 타입의 데이터를 저장 할 수 있음
	 * 
	 * < 컬렉션의 종류 >
	 * 
	 ...
	 *   ㄴ 중복 데이터 허용됨
	 *   ㄴ 하위 클래스 : Vector , "ArrayList"(중요) , LinkedList, ....
	 *   
	 *   
	 * 2.Set : 집합 형태의 컬렉션
	 *   ㄴ 데이터(value)만 저장 가능
	 ...
	 *   
	 * 3.Map : 객체(인스터스)를 대신해서 사용되는 컬렉션
	 *   ㄴ 키(key)와 함께 데이터(value)를 저장
	 *   ㄴ 순서 유지되지 않음
	 *   ㄴ 중복된 키(key) 허용 안됨
	 * 	 ㄴ 하위 클래스 : "HashMap"(중요),TreeMap,"Properties"
	 */
