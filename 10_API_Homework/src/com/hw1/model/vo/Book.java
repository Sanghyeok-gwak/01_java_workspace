...
public class Book {
	...
	public String toString() {
		...
		// 코드 작성
		int y =publishDate.get(Calendar.YEAR);
		int m =publishDate.get(Calendar.MONTH)+1;
		int d =publishDate.get(Calendar.DATE);
		
//		SimpleDateFormat sdf = new SimpleDateFormat("yyyy년 MM월 dd일");
//		String result =sdf .format(publishDate.getTimeInMillis());
